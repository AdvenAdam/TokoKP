                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <form action="/service/save" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row showcase_row_area">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control <?= ($validation->hasError('kerusakan')) ? 'is-invalid' : ''; ?>" require id="kerusakan" name="kerusakan" value="<?= old('kerusakan'); ?>">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="form-group row showcase_row_area">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control <?= ($validation->hasError('pc')) ? 'is-invalid' : ''; ?>" require id="pc" name="pc" value="<?= old('pc'); ?>">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="form-group row showcase_row_area">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control <?= ($validation->hasError('status')) ? 'is-invalid' : ''; ?>" require id="status" name="status" value="<?= old('status'); ?>">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="form-group row showcase_row_area">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control <?= ($validation->hasError('biaya')) ? 'is-invalid' : ''; ?>" require id="biaya" name="biaya" value="<?= old('biaya'); ?>">
                                                    <div class="invalid-feedback">
                                            ...
                                            <div class="form-group row showcase_row_area">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control <?= ($validation->hasError('no_hp')) ? 'is-invalid' : ''; ?>" require id="no_hp" name="no_hp" value="<?= old('no_hp'); ?>">
                                                    <div class="invalid-feedback">

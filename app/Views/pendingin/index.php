            ...
            <div class="row">
                <div class="col-12 py-5">
                    <div class="grid">
                        ...
                        <?php endif; ?>
                        <div class="card-body">
                            <a href="/pendingin/create" class="btn btn-primary ">Tambah Data</a>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($pendingin as $val) : ?>
                                        <tr align="middle">
                                            ...
                                            <td><?= $val['harga']; ?></td>
                                            <td><?= $val['stok']; ?></td>
                                            <td><a href="/pendingin/<?= $val['slug']; ?>" class="btn btn-info"><i class="mdi mdi-magnify"></i></a>
                                                <a href="/pendingin/edit/<?= $val['slug']; ?>" class="btn btn-light"><i class="mdi mdi-pencil-box-outline"></i></a>

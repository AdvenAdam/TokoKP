...
<div class="page-content-wrapper">
    <div class="page-content-wrapper-inner">
        ...
        <div class="row">
            <?php $i = 1; ?>
            <?php $x = 1; ?>
            <?php foreach ($procesor as $key => $value) { ?>
                <div class="col-md-3 col-sm-6 col-6 equel-grid">
                    <form action="/procesor/addstok/<?= $value['id']; ?>" method="post" enctype="multipart/form-data">
                        <div class="grid">
                            ...
                            <div class="grid-body text-gray mt-1">
                                <div class="d-flex justify-content-between mb-3">
                                    <img src="/img/procesor/<?= $value['gambar']; ?>" width="200px" height="150px">
                                </div>
                                <?= $value['stok']; ?><br>
